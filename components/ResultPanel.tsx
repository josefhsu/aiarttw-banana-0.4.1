...
const ImageCard: React.FC<{
    ...
    return (
        <div 
            className="relative group bg-black rounded-lg themed-panel cyber-glow-corners overflow-hidden"
            style={{ aspectRatio: image.aspectRatio ? image.aspectRatio.replace(':', ' / ') : (image.width && image.height ? `${image.width} / ${image.height}` : '1 / 1') }}
        >
    ...
    <main className="flex-1 flex flex-col p-2 md:p-4 bg-transparent min-w-0 overflow-y-auto cyber-glow-corners">
      {hasContent ? (
        ...
        <div className="flex flex-col items-center justify-center text-center h-full text-slate-400 p-4">
            ...
            />
          <h2 className="text-2xl font-bold mb-2 text-white themed-text-glow"><a href="https://aiarttw.us/nano" target="_blank">來夜城，鳥巢幫你裝上腦機，創造幻夢～</a></h2>
          <p className="max-w-md mb-6 text-slate-500 text-xm themed-text-glow"><a href="https://aiarttw.us/nano" target="_blank">瞎毀？世界首創 竟然還有***官方主題曲***可以聽！</a></p>
