...
export const NIGHT_CITY_SCENE_PROMPTS = {
    ...
    '破損的公路': 'The crumbling, elevated highways that crisscross Dogtown, offering dangerous shortcuts.',
...
export const NIGHT_CITY_COMPANIONS = {
    '男性': [
        'Jackie Welles (傑奇·威爾斯)', 'Goro Takemura (竹村五郎)', 'Kerry Eurodyne (凱瑞·歐羅丹)', 'River Ward (瑞佛·沃德)', 'Viktor Vektor (維克多·Vector)', 'Mitch Anderson (米契·安德森)', 'Saul Bright (索爾·布萊特)', 'Placide (普拉西德)', 'Ozob Bozo (噁心幫·波索)', 'Denny (丹妮)', 'Hideo Kojima (小島秀夫)',
    ],
    '女性': [
    ...
    '其他': [
        'Johnny Silverhand (強尼·銀手)', 'Delamain (德拉曼)', 'Brendan (布蘭登)', 'Skippy (小嗶)', 'Nibbles the Cat (小貓尼波)', 'Granny (老奶奶)', 'Sandra Dorsett (珊卓·多賽特)', 'Regina Jones (芮琪娜·瓊斯)', 'Mr. Hands (手手先生)', 'Songbird (鳴鳥)',
    ]
};
